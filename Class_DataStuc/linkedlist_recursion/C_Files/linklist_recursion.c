...
{
    if(Booklist_HeadNode->Save_address != NULL)
    {
        Booklist_HeadNode = Booklist_HeadNode->Save_address;
        Find_FinNode(Booklist_HeadNode);
    }
    else
    {
        return Booklist_HeadNode;
    }
}