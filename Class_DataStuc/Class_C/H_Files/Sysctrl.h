...
char ListChoiceInsert(Book_sequTable Book_list, Book Book_Msg, unsigned char local);
// char ListChoiceDelete(Book_sequTable Book_list, Book Book_Msg, unsigned char local);
